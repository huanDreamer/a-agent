<script setup>
// 技能 panel — the skill list with its on/off switch
// (POST /api/skills/{name} with {"enabled":bool}).
//
// It is a panel, not a page: 设置 mounts it as one of its sections.
  ...
  <div class="card">
    <div class="card-head">
      <div class="card-title">
        ...
        技能开关
        <span class="card-sub">
          已启用 {{ formatCount(enabledCount) }} / {{ formatCount(skills.length) }} · 切换会立即生效并写入配置
        </span>
      </div>
