...
import { formatAbsolute, formatCount, formatDuration, formatRelative, shortId, truncate } from '../format.js'
...
<template>
  <div class="stack">
    <div class="page-head">
      ...
      <div class="row">
        <span class="muted-note" v-if="!filterActive">共 {{ formatCount(rows.length) }} 条</span>
        <span class="muted-note" v-else>命中 {{ formatCount(rows.length) }} 条</span>
